import{L as U,d as N,e as L,f as P,g as S,h as _,j as v,l as x}from"./chunk-MIAHAHIO.js";import{Ob as M,V as w,X as p,a,bb as m,db as F,ea as O,ja as A,ra as C}from"./chunk-HIGDP7LJ.js";var l=(function(s){return s[s.FADING_IN=0]="FADING_IN",s[s.VISIBLE=1]="VISIBLE",s[s.FADING_OUT=2]="FADING_OUT",s[s.HIDDEN=3]="HIDDEN",s})(l||{}),E=class{_renderer;element;config;_animationForciblyDisabledThroughCss;state=l.HIDDEN;constructor(t,e,n,i=!1){this._renderer=t,this.element=e,this.config=n,this._animationForciblyDisabledThroughCss=i}fadeOut(){this._renderer.fadeOutRipple(this)}},k=_({passive:!0,capture:!0}),b=class{_events=new Map;addHandler(t,e,n,i){let r=this._events.get(e);if(r){let c=r.get(n);c?c.add(i):r.set(n,new Set([i]))}else this._events.set(e,new Map([[n,new Set([i])]])),t.runOutsideAngular(()=>{document.addEventListener(e,this._delegateEventHandler,k)})}removeHandler(t,e,n){let i=this._events.get(t);if(!i)return;let r=i.get(e);r&&(r.delete(n),r.size===0&&i.delete(e),i.size===0&&(this._events.delete(t),document.removeEventListener(t,this._delegateEventHandler,k)))}_delegateEventHandler=t=>{let e=P(t);e&&this._events.get(t.type)?.forEach((n,i)=>{(i===e||i.contains(e))&&n.forEach(r=>r.handleEvent(t))})}},H={enterDuration:225,exitDuration:150},j=800,G=_({passive:!0,capture:!0}),B=["mousedown","touchstart"],z=["mouseup","mouseleave","touchend","touchcancel"],X=(()=>{class s{static \u0275fac=function(n){return new(n||s)};static \u0275cmp=m({type:s,selectors:[["ng-component"]],hostAttrs:["mat-ripple-style-loader",""],decls:0,vars:0,template:function(n,i){},styles:[`.mat-ripple {
  overflow: hidden;
  position: relative;
}
...
`],encapsulation:2,changeDetection:0})}return s})();export{H as a,D as b,J as c,lt as d,pt as e};
